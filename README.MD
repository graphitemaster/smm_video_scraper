...
The following is a tool that given a YT URL of SMM game play with the warp bar can extract level codes and the timestamp in the URL of where that level was played as provide information about the level name and and it's creator.
